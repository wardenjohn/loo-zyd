...
void MemCollectorUnittest::TestCollect() const {
    ...
    APSARA_TEST_TRUE(collector.Collect(collectConfig, &group));
    APSARA_TEST_TRUE(collector.Collect(collectConfig, &group));
    vector<double> expected1 = {31534908.0*1024,
                                13226912*1024,
                                28771376*1024,
                                28771376*1024,
                                (31534908-28771376)*1024,
                                (static_cast<double>(31534908-28771376)/static_cast<double>(31534908))*100.0,
                                28771376.0*100.0/31534908.0};
    vector<double> expected2 = {31534908.0*1024,
                                13226912*1024,
                                28771376*1024,
                                28771376*1024,
                                (31534908-28771376)*1024,
                                (static_cast<double>(31534908-28771376)/static_cast<double>(31534908))*100.0,
                                28771376.0*100.0/31534908.0};
    vector<double> expected3 = {31534908.0*1024,
                                13226912*1024,
                                28771376*1024,
                                28771376*1024,
                                (31534908-28771376)*1024,
