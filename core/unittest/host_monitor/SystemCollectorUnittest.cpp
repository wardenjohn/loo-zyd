...
void SystemCollectorUnittest::TestGetHostSystemLoadStat() const {
    ...
    APSARA_TEST_EQUAL_FATAL(0.10 / cores, stat.load1PerCore);
    APSARA_TEST_EQUAL_FATAL(0.07 / cores, stat.load5PerCore);
    APSARA_TEST_EQUAL_FATAL(0.03 / cores, stat.load15PerCore);
}
